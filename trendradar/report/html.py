...
def render_html_content(
    ...
    *,
    ...
    # 样式定义：基于提供的参考HTML代码，并补充了新增热点和错误提示的适配样式
    css_style = """
        * { box-sizing: border-box; }
        ...
        .news-title {
            ...
            color: #1a1a1a;
            margin: 0;
            word-break: break-word; /* 保持原有逻辑防止长单词溢出 */
        ...
        /* 以下是参考代码未包含，但逻辑需要的样式 (错误提示与新增热点)，已按新风格优化 */
        .error-section {
            background: #fef2f2;
        ...
        <script>
            ...
            async function saveAsMultipleImages() {
                ...
                try {
                    ...
                    // 获取所有可能的分割元素
                    // 注意：这里需要根据新的DOM结构获取元素，逻辑保持不变，但要确保选择器匹配
